...
connection = mysql.connector.connect(host='localhost', user='root', password='', port='3306', database='test_py')
c = connection.cursor()
...
def insertData():
    ...
    c.execute(insert_query,vals) #Executar insert com os valores definidos
    connection.commit() #Fazer commit
